...
- Setup and info
  ...
  - 5JfWyyooqZbKpA9ZbZSrbPke4TKyxV2mo5wcLEptQ5NG is the address of the Mango v4 Program
...
- Create IDL buffer
  ...
  anchor idl write-buffer --provider.cluster $RPC_URL --provider.wallet $KEY --filepath target/idl/mango_v4_no_docs.json 5JfWyyooqZbKpA9ZbZSrbPke4TKyxV2mo5wcLEptQ5NG

  Save the returned address as $IDL_BUFFER

- Set IDL buffer authority

  anchor idl set-authority --provider.cluster $RPC_URL --provider.wallet $KEY --program-id 5JfWyyooqZbKpA9ZbZSrbPke4TKyxV2mo5wcLEptQ5NG --new-authority FP4PxqHTVzeG2c6eZd7974F9WvKUSdBeduUK3rjYyvBw $IDL_BUFFER
